        ...
        <td nowrap="" valign="top" width="125">
         ...
         <p>
          <span class="content">
           ...
           <p>
            <a href="/bb/reports/1984/84-03-su.cfm">
             Next Summary
            </a>
           </p>
           <p>
...
inventories.
          ...
          <p>
           Automobile sales have been brisk, although low inventories have been 
a limiting factor in several districts.
          </p>
          <p>
           <strong>
            Manufacturing
...
improving slightly.
          ...
          <p>
           Capital spending is picking up. Philadelphia, commenting on its 
survey of manufacturers, observes that "for the first time in seven 
years, half of the respondents...intend to increase outlays for 
plant and equipment during the next six months." The emphasis is on 
modernization and productivity enhancement, but some expansions are 
planned.
          </p>
          <p>
           Price increases are reported to be more frequent but, for the most 
part, still moderate. Lead times are lengthening. According to 
Chicago, cutbacks in domestic capacity have contributed to the 
scattered supply problems.
          </p>
          <p>
           In the Atlanta and Dallas districts, higher rig counts point to a 
recovery in drilling activity. Minneapolis also reports an upturn in 
oil activity, but not in gas and coal.
          </p>
          <p>
           Increased manufacturing activity has been reflected in more trucking 
and railroad business in the St. Louis district. Barge traffic has 
