    ...
    <div id="standard_layout">
     <div id="standard_layout_col2_full">
      <table border="0" cellpadding="5" width="620">
       <tr>
        <td nowrap="" valign="top" width="120">
         <p>
         </p>
         <p>
         </p>
         ...
         <p>
          <a href="/bb/reports/2003/03-07-su.cfm">
           <br/>
          </a>
          <br/>
         </p>
         ...
         <p>
          ...
          <br/>
          <font size="-1">
           <a href="/bb/reports/2003/03-10-su.cfm">
            Next Summary
           </a>
          </font>
         </p>
        ...
        <td valign="top" width="440">
         ...
         <span class="content">
          Reports from the twelve Federal Reserve districts 
            indicate that the economy continued to improve in July and August. 
            Eleven districts say that activity levels increased during the summer. 
            In some districts, improvement occurred in selected sectors, and in 
            others, it was broad-based. Even in the Dallas district, where activity 
            remains generally weak, contacts are said to be more optimistic.
         </span>
         <p>
          <span class="content">
           Consumer activity showed improvement in 
              most districts. But Kansas City, Philadelphia, and Boston noted 
              that the increases in retail sales were slight or modest, and New 
              York indicated retail results were better in July than August (partly 
              on account of the August blackout). And retail sales were weak
          </span>
          or softening according to respondents in the Cleveland and St. Louis 
              districts.
         </p>
         <p>
